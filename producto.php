...
$resultado=mysql_query("select * from producto where claveProducto".$_GET['claveProducto']) or die(mysql_error());
while ($fila=mysql_fetch_array($resultado)) {
	...
	?>
					...
					<div class="product__info">
						...
						<a href="producto.php?id=<?php echo $fila['claveProducto']; ?>"
						<button class="action action--button action--buy"><i class="fa fa-shopping-cart"></i><span class="action__text">Info</span></button></a>
					</div>
